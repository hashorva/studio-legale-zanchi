          ...
          <div className="rounded-2xl border border-white/20 bg-white/50 backdrop-blur-md shadow-2xl max-h-[90vh] flex flex-col">
            <div className="overflow-y-auto flex-1 p-6">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                ...
                e, solo con il tuo consenso, cookie analitici e servizi di terze
                parti. Puoi accettare tutti, rifiutare quelli non necessari
                oppure gestire le tue preferenze in modo granulare.
              </p>
                  ...
                  >
                    ...
                    <div>
                      {cookieCategories.map((category, index) => (
                        <div
                          key={category.key}
                          className={`flex flex-col mx-4 px-2 py-3 ${index !== cookieCategories.length - 1 ? 'border-b border-border' : ''}`}
                        >
            ...
            {/* Action buttons */}
            <div className="flex gap-2 p-4 border-t border-white/20 justify-between flex-shrink-0 flex-wrap">
              <Button
                variant="subtle"
              ...
              <div className="flex gap-2 w-full sm:w-auto justify-end">
                <Button variant="subtle" onClick={rejectAll} className='flex-1 sm:flex-none'>
                  Rifiuta tutti
                </Button>
                <Button
